...
import { CaretCircleRight, Package, Globe, Pulse, Bell } from "@phosphor-icons/react";
import { useScrollReveal } from "@/hooks/use-scroll-reveal";

const values = [
  { icon: Package, title: "Sınırsız ürün & kategori", desc: "Menünüzde istediğiniz kadar kategori ve ürün olsun. Tüm planlarda sınırsız." },
  { icon: Globe, title: "Çok dilli menü", desc: "Pro'da 2 dil, Premium'da 4 dil. Yabancı misafirleriniz kendi dilinde görsün." },
  { icon: Pulse, title: "Alerjen & kalori bilgisi", desc: "Her üründe alerjen ikonları ve kalori değeri. Misafir güvenle sipariş verir." },
        ...
        <div className="text-center">
          <a href="#fiyatlar">
            <Button variant="hero" size="lg" className="rounded-full px-8 text-base" onClick={(e) => { e.preventDefault(); document.querySelector('#fiyatlar')?.scrollIntoView({ behavior: 'smooth' }); }}>
              Planları İncele <CaretCircleRight className="w-4 h-4" />
            </Button>
          </a>
        </div>
      </div>
