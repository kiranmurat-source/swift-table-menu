  ...
  return (
    <div style={{ minHeight: '100vh', background: '#fafaf9', fontFamily: "'Inter', -apple-system, sans-serif" }}>
      <div style={{ borderBottom: '1px solid #e7e5e4', background: '#fff', padding: '12px 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <span style={{ fontSize: 18, fontWeight: 800, letterSpacing: '-0.3px', color: '#1c1917' }}>tabbled {role === 'super_admin' && <span style={{ fontSize: 11, fontWeight: 600, color: '#fff', background: '#dc2626', padding: '2px 8px', borderRadius: 4, marginLeft: 8, verticalAlign: 'middle' }}>ADMIN</span>}</span>
