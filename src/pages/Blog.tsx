    ...
    <>
      <Helmet>
        ...
        <meta
          ...
          content="QR menü yönetmeliği, fiyatlandırma, tasarım stratejileri ve daha fazlası."
        />
        ...
        <div className="container">
          ...
          {filteredPosts.length === 0 ? (
            <div className="py-16 text-center text-text-secondary">
              <p className="mb-1 text-base">Yakın zamanda blog yazıları yayınlanacak.</p>
              <p className="text-sm">Takipte kalın!</p>
            </div>
          ) : (
